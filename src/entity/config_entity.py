...
class DataIngestionConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.train_test_split_ratio: float = constant.DATA_INGESTION_TEST_RATIO
...
class DataValidationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.drift_report_file_path: str = os.path.join(
            ...
            constant.DATA_VALIDATION_DRIFT_REPORT_FILENAME,
        )
...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.overfitting_underfitting_threshold = constant.MODEL_TRAINER_OVERFIT_UNDERFIT_THRESHOLD